...
export default function PublicFooter() {
  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        { label: t('useCaseSalonsTitle'), href: '#use-cases' },
        { label: t('useCaseClinicsTitle'), href: '#use-cases' },
        { label: t('useCaseCoachesTitle'), href: '#use-cases' },
        { label: t('useCaseEcomTitle'), href: '#use-cases' },
      ],
    },
    {
      ...
      links: [
        ...
        { label: t('footerTerms'), href: '/terms', isRoute: true },
        { label: t('footerPrivacy'), href: '/privacy', isRoute: true },
      ],
    },
    {
  ...
  return (
    <footer className="border-t border-b-border py-16 px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-surface border border-b-border flex items-center justify-center text-dim hover:text-foreground hover:border-blue-500/30 transition-all">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-surface border border-b-border flex items-center justify-center text-dim hover:text-foreground hover:border-blue-500/30 transition-all">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-surface border border-b-border flex items-center justify-center text-dim hover:text-foreground hover:border-pink-500/30 transition-all">
